"""Summarize author short-term outer-fold predictions."""
...
from keysubgraph.crossfit.author_short_term_summary import (  # noqa: E402
...
def main():
    ...
    assignments = (
        ...
        else args.output_root / "assignments" / "fold_assignments.json"
    )
