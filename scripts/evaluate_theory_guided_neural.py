"""Evaluate a Stage-1 model with its frozen validation threshold."""
...
def parse_args():
    ...
    parser.add_argument(
        "--threshold-strategy", choices=("balanced_accuracy", "accuracy"),
...
def main():
    ...
    result = evaluate_theory_neural_classifier(
        model, loader, args.checkpoint, device, args.output,
